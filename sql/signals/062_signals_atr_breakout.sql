-- signals_atr_breakout: ATR breakout trading signals
--
...
CREATE TABLE IF NOT EXISTS public.signals_atr_breakout (
    -- Primary key
    id                      INTEGER         NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_cmc_signals_atr_bo_open_positions
    ON public.signals_atr_breakout (id, signal_id, position_state)
