-- backtest_metrics: Comprehensive backtest performance metrics
--
...
CREATE INDEX IF NOT EXISTS idx_backtest_metrics_run
    ON public.backtest_metrics(run_id);

CREATE INDEX IF NOT EXISTS idx_backtest_metrics_sharpe
    ON public.backtest_metrics(sharpe_ratio DESC NULLS LAST);

CREATE INDEX IF NOT EXISTS idx_backtest_metrics_calmar
    ON public.backtest_metrics(calmar_ratio DESC NULLS LAST);
