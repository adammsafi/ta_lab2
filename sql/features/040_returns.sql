...
-- DEPRECATED: This table is replaced by returns_bars_multi_tf which provides
...
--
-- Source: price_bars_multi_tf (all timeframes)
...
'Multi-TF returns calculated from price_bars_multi_tf. Column ret_N_pct = N-bar return (timeframe-agnostic).';
