-- =============================================================================
-- ic_results -- Information Coefficient evaluation results
-- =============================================================================
-- Reference DDL for the ic_results table.
...
CREATE TABLE IF NOT EXISTS public.ic_results (
    -- Primary key
    ...
    -- Feature name (column name from features)
...
CREATE INDEX IF NOT EXISTS idx_ic_results_asset_feature
    ON public.ic_results (asset_id, tf, feature);

CREATE INDEX IF NOT EXISTS idx_ic_results_computed_at
    ON public.ic_results (computed_at);

-- Table description
COMMENT ON TABLE public.ic_results IS
