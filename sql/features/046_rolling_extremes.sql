...
CREATE TABLE IF NOT EXISTS public.rolling_extremes (
...
CREATE INDEX IF NOT EXISTS idx_rolling_extremes_id_tf_w_ts
ON public.rolling_extremes (id, tf, alignment_source, lookback_bars, ts DESC);

COMMENT ON TABLE public.rolling_extremes IS
