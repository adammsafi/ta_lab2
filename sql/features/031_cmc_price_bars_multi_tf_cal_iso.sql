CREATE TABLE IF NOT EXISTS public.cmc_price_bars_multi_tf_cal_iso (
  id          integer                     NOT NULL,
  tf          text                        NOT NULL,
  ...
  CONSTRAINT pk_cmc_price_bars_multi_tf_cal_iso PRIMARY KEY (id, tf, bar_seq)
);

-- Optional helper index (common query pattern)
CREATE INDEX IF NOT EXISTS ix_cmc_price_bars_multi_tf_cal_iso_id_tf_timeclose
