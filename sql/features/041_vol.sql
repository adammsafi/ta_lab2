...
CREATE TABLE IF NOT EXISTS public.vol (
    -- Primary key
    id              INTEGER NOT NULL,
...
COMMENT ON TABLE public.vol IS
'Multi-TF volatility measures from price_bars_multi_tf OHLC. Annualization: periods_per_year = max(12, round(252/tf_days)).';
