...
-- Table: ic_results (1 new column)
-- =============================================================================

ALTER TABLE public.ic_results
    ADD COLUMN rank_ic NUMERIC;

COMMENT ON COLUMN public.ic_results.rank_ic IS
...
-- Table: backtest_trades (2 new columns)
-- =============================================================================

ALTER TABLE public.backtest_trades
    ADD COLUMN mae NUMERIC;

COMMENT ON COLUMN public.backtest_trades.mae IS
...
COMMENT ON COLUMN public.backtest_trades.mfe IS
...
-- Tables: backtest_metrics (4 new columns) + backtest_runs (1 new column)
-- =============================================================================

ALTER TABLE public.backtest_metrics
    ADD COLUMN mc_sharpe_lo NUMERIC;

COMMENT ON COLUMN public.backtest_metrics.mc_sharpe_lo IS
...
COMMENT ON COLUMN public.backtest_metrics.mc_sharpe_hi IS
...
COMMENT ON COLUMN public.backtest_metrics.mc_sharpe_median IS
...
COMMENT ON COLUMN public.backtest_metrics.mc_n_samples IS
...
COMMENT ON COLUMN public.backtest_runs.tearsheet_path IS
...
COMMENT ON COLUMN public.features.ret_arith_cs_zscore IS
...
COMMENT ON COLUMN public.features.ret_arith_cs_rank IS
...
COMMENT ON COLUMN public.features.rsi_14_cs_zscore IS
...
COMMENT ON COLUMN public.features.rsi_14_cs_rank IS
...
COMMENT ON COLUMN public.features.vol_parkinson_20_cs_zscore IS
...
COMMENT ON COLUMN public.features.vol_parkinson_20_cs_rank IS
