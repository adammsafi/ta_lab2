-- 1) From ema_multi_tf_cal  → alignment_source = 'calendar'
...
-- 2) From ema_multi_tf_cal_anchor  → alignment_source = 'calendar_anchor'
INSERT INTO ema_multi_tf_u (
    id,
    ts,
    tf,
...
-- 3) From ema_multi_tf (v1 tf-day engine)  → alignment_source = 'tf_day'
...
-- 4) From ema_multi_tf_v2 (pure daily engine) → alignment_source = 'v2_daily'
