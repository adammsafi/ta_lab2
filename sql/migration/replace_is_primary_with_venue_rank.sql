...
UPDATE public.price_bars_1d b SET venue_rank = COALESCE(dl.venue_rank, 50)
FROM public.dim_listings dl
WHERE dl.id = b.id AND dl.venue = b.venue;

ALTER TABLE public.price_bars_1d DROP COLUMN IF EXISTS is_primary_venue;
...
UPDATE public.price_bars_multi_tf b SET venue_rank = COALESCE(dl.venue_rank, 50)
FROM public.dim_listings dl
WHERE dl.id = b.id AND dl.venue = b.venue;

ALTER TABLE public.price_bars_multi_tf DROP COLUMN IF EXISTS is_primary_venue;
...
UPDATE public.price_bars_multi_tf_cal_us b SET venue_rank = COALESCE(dl.venue_rank, 50)
FROM public.dim_listings dl
WHERE dl.id = b.id AND dl.venue = b.venue;

ALTER TABLE public.price_bars_multi_tf_cal_us DROP COLUMN IF EXISTS is_primary_venue;
...
UPDATE public.price_bars_multi_tf_cal_iso b SET venue_rank = COALESCE(dl.venue_rank, 50)
FROM public.dim_listings dl
WHERE dl.id = b.id AND dl.venue = b.venue;

ALTER TABLE public.price_bars_multi_tf_cal_iso DROP COLUMN IF EXISTS is_primary_venue;
...
UPDATE public.price_bars_multi_tf_cal_anchor_us b SET venue_rank = COALESCE(dl.venue_rank, 50)
FROM public.dim_listings dl
WHERE dl.id = b.id AND dl.venue = b.venue;

ALTER TABLE public.price_bars_multi_tf_cal_anchor_us DROP COLUMN IF EXISTS is_primary_venue;
...
UPDATE public.price_bars_multi_tf_cal_anchor_iso b SET venue_rank = COALESCE(dl.venue_rank, 50)
FROM public.dim_listings dl
WHERE dl.id = b.id AND dl.venue = b.venue;

ALTER TABLE public.price_bars_multi_tf_cal_anchor_iso DROP COLUMN IF EXISTS is_primary_venue;
...
UPDATE public.price_bars_multi_tf_u b SET venue_rank = COALESCE(dl.venue_rank, 50)
FROM public.dim_listings dl
WHERE dl.id = b.id AND dl.venue = b.venue;

ALTER TABLE public.price_bars_multi_tf_u DROP COLUMN IF EXISTS is_primary_venue;

DROP INDEX IF EXISTS uq_price_bars_multi_tf_u__canon_timestamp;
CREATE UNIQUE INDEX uq_price_bars_multi_tf_u__canon_timestamp
...
ALTER TABLE public.price_bars_multi_tf_state
  ADD COLUMN IF NOT EXISTS venue TEXT NOT NULL DEFAULT 'CMC_AGG';
ALTER TABLE public.price_bars_multi_tf_state
  DROP CONSTRAINT IF EXISTS price_bars_multi_tf_state_pkey;
ALTER TABLE public.price_bars_multi_tf_state
  ADD PRIMARY KEY (id, tf, venue);

-- price_bars_multi_tf_cal_us_state
ALTER TABLE public.price_bars_multi_tf_cal_us_state
  ADD COLUMN IF NOT EXISTS venue TEXT NOT NULL DEFAULT 'CMC_AGG';
ALTER TABLE public.price_bars_multi_tf_cal_us_state
  DROP CONSTRAINT IF EXISTS price_bars_multi_tf_cal_us_state_pkey;
ALTER TABLE public.price_bars_multi_tf_cal_us_state
  ADD PRIMARY KEY (id, tf, venue);

-- price_bars_multi_tf_cal_iso_state
ALTER TABLE public.price_bars_multi_tf_cal_iso_state
  ADD COLUMN IF NOT EXISTS venue TEXT NOT NULL DEFAULT 'CMC_AGG';
ALTER TABLE public.price_bars_multi_tf_cal_iso_state
  DROP CONSTRAINT IF EXISTS price_bars_multi_tf_cal_iso_state_pkey;
ALTER TABLE public.price_bars_multi_tf_cal_iso_state
  ADD PRIMARY KEY (id, tf, venue);

-- price_bars_multi_tf_cal_anchor_us_state
ALTER TABLE public.price_bars_multi_tf_cal_anchor_us_state
  ADD COLUMN IF NOT EXISTS venue TEXT NOT NULL DEFAULT 'CMC_AGG';
ALTER TABLE public.price_bars_multi_tf_cal_anchor_us_state
  DROP CONSTRAINT IF EXISTS price_bars_multi_tf_cal_anchor_us_state_pkey;
ALTER TABLE public.price_bars_multi_tf_cal_anchor_us_state
  ADD PRIMARY KEY (id, tf, venue);

-- price_bars_multi_tf_cal_anchor_iso_state
ALTER TABLE public.price_bars_multi_tf_cal_anchor_iso_state
  ADD COLUMN IF NOT EXISTS venue TEXT NOT NULL DEFAULT 'CMC_AGG';
ALTER TABLE public.price_bars_multi_tf_cal_anchor_iso_state
  DROP CONSTRAINT IF EXISTS price_bars_multi_tf_cal_anchor_iso_state_pkey;
ALTER TABLE public.price_bars_multi_tf_cal_anchor_iso_state
  ADD PRIMARY KEY (id, tf, venue);
