...
-- Source tables:
--   - price_bars_1d (OHLCV)
--   - ema_multi_tf_u (EMAs for 1D timeframe)
--   - returns_daily (returns across multiple lookbacks)
...
CREATE TABLE IF NOT EXISTS public.cmc_daily_features (
    ...
    -- Price context (from price_bars_1d)
    ...
    -- EMAs (from ema_multi_tf_u, pivoted for 1D timeframe)
