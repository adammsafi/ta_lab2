-- create_price_bars_multi_tf_u.sql
--
...
CREATE TABLE IF NOT EXISTS public.price_bars_multi_tf_u (
    id                          integer       NOT NULL,
...
ON public.price_bars_multi_tf_u (alignment_source);

CREATE INDEX IF NOT EXISTS ix_price_bars_u_id_tf_ts
ON public.price_bars_multi_tf_u (id, tf, "timestamp");

CREATE INDEX IF NOT EXISTS ix_price_bars_u_ingested
ON public.price_bars_multi_tf_u (ingested_at);
