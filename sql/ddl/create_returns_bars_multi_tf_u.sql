-- create_returns_bars_multi_tf_u.sql
--
...
CREATE TABLE IF NOT EXISTS public.returns_bars_multi_tf_u (
    id                          integer       NOT NULL,
...
ON public.returns_bars_multi_tf_u (alignment_source);

CREATE INDEX IF NOT EXISTS ix_returns_bars_u_id_tf_ts
ON public.returns_bars_multi_tf_u (id, tf, "timestamp");

CREATE INDEX IF NOT EXISTS ix_returns_bars_u_ingested
ON public.returns_bars_multi_tf_u (ingested_at);
