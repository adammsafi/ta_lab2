...
-- Creates:
--   public.returns_ema_multi_tf       (unified timeline: _ema/_ema_bar + _roll pairs)
--   public.returns_ema_multi_tf_state
--
...
CREATE TABLE IF NOT EXISTS public.returns_ema_multi_tf (
    id          bigint       NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.returns_ema_multi_tf_state (
    id          bigint      NOT NULL,
    tf          text        NOT NULL,
    period      integer     NOT NULL,
    last_ts     timestamptz,
...
CREATE INDEX IF NOT EXISTS ix_returns_ema_multi_tf_key
ON public.returns_ema_multi_tf (id, tf, period, ts);

CREATE INDEX IF NOT EXISTS ix_returns_ema_multi_tf_ingested_at
ON public.returns_ema_multi_tf (ingested_at);
