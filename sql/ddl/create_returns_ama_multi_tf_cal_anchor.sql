-- create_returns_ama_multi_tf_cal_anchor.sql
-- Creates calendar-anchor AMA returns tables:
--   public.returns_ama_multi_tf_cal_anchor_us       (US anchor alignment)
--   public.returns_ama_multi_tf_cal_anchor_us_state
--   public.returns_ama_multi_tf_cal_anchor_iso      (ISO anchor alignment)
...
-- ============================================================
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_cal_anchor_us (
    id              bigint       NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_cal_anchor_us_state (
    id          bigint      NOT NULL,
    tf          text        NOT NULL,
    indicator   text        NOT NULL,
    params_hash text        NOT NULL,
...
ON public.returns_ama_multi_tf_cal_anchor_us (id, tf, indicator, params_hash, ts);

CREATE INDEX IF NOT EXISTS ix_cmc_returns_ama_cal_anchor_us_ingested
ON public.returns_ama_multi_tf_cal_anchor_us (ingested_at);


-- ============================================================
-- CAL ANCHOR ISO returns + state
-- ============================================================
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_cal_anchor_iso (
    id              bigint       NOT NULL,
    ts              timestamptz  NOT NULL,
    tf              text         NOT NULL,
    tf_days         integer      NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_cal_anchor_iso_state (
    id          bigint      NOT NULL,
    tf          text        NOT NULL,
    indicator   text        NOT NULL,
    params_hash text        NOT NULL,
...
ON public.returns_ama_multi_tf_cal_anchor_iso (id, tf, indicator, params_hash, ts);

CREATE INDEX IF NOT EXISTS ix_cmc_returns_ama_cal_anchor_iso_ingested
ON public.returns_ama_multi_tf_cal_anchor_iso (ingested_at);
