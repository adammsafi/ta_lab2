-- create_returns_ama_multi_tf.sql
-- Creates:
--   public.returns_ama_multi_tf       (main AMA returns table)
--   public.returns_ama_multi_tf_state (watermark state)
--
...
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf (
    id              bigint       NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_state (
    id          bigint      NOT NULL,
    tf          text        NOT NULL,
    indicator   text        NOT NULL,
    params_hash text        NOT NULL,
...
CREATE INDEX IF NOT EXISTS ix_returns_ama_multi_tf_key
ON public.returns_ama_multi_tf (id, tf, indicator, params_hash, ts);

CREATE INDEX IF NOT EXISTS ix_returns_ama_multi_tf_ingested_at
ON public.returns_ama_multi_tf (ingested_at);
