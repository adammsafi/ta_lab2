CREATE TABLE IF NOT EXISTS public.price_bars_1d_state (
...
ALTER TABLE public.price_bars_1d_state
...
UPDATE public.price_bars_1d_state
SET daily_min_seen = last_src_ts
WHERE daily_min_seen IS NULL;

-- Comment explaining purpose
COMMENT ON COLUMN public.price_bars_1d_state.daily_min_seen IS
