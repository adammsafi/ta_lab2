...
DROP TABLE IF EXISTS public.cmc_returns_bars_multi_tf_cal_us CASCADE;

CREATE TABLE public.cmc_returns_bars_multi_tf_cal_us (
    id                      integer       NOT NULL,
    ...
    CONSTRAINT cmc_returns_bars_multi_tf_cal_us_pk PRIMARY KEY (id, "timestamp", tf)
);

CREATE INDEX IF NOT EXISTS ix_cmc_returns_bars_multi_tf_cal_us_id_tf_ts
ON public.cmc_returns_bars_multi_tf_cal_us (id, tf, "timestamp");

DROP TABLE IF EXISTS public.cmc_returns_bars_multi_tf_cal_us_state CASCADE;

CREATE TABLE public.cmc_returns_bars_multi_tf_cal_us_state (
    id              integer       NOT NULL,
    tf              text          NOT NULL,
