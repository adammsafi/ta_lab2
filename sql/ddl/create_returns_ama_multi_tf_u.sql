-- create_returns_ama_multi_tf_u.sql
-- Creates:
--   public.returns_ama_multi_tf_u       (unified AMA returns table)
--   public.returns_ama_multi_tf_u_state
--
...
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_u (
    id               bigint       NOT NULL,
...
ON public.returns_ama_multi_tf_u (id, tf, indicator, params_hash, alignment_source, ts);

CREATE INDEX IF NOT EXISTS ix_ret_ama_u_indicator
ON public.returns_ama_multi_tf_u (indicator, params_hash, tf);

CREATE INDEX IF NOT EXISTS ix_ret_ama_u_alignment_source
ON public.returns_ama_multi_tf_u (alignment_source);

CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_u_state (
    id               bigint      NOT NULL,
    tf               text        NOT NULL,
    indicator        text        NOT NULL,
    params_hash      text        NOT NULL,
