...
-- Unified EMA returns built from public.ema_multi_tf_u
--
...
CREATE TABLE IF NOT EXISTS public.returns_ema_multi_tf_u (
    id               bigint NOT NULL,
...
ON public.returns_ema_multi_tf_u (tf, period);

CREATE INDEX IF NOT EXISTS ix_ret_ema_u_alignment_source
ON public.returns_ema_multi_tf_u (alignment_source);

CREATE TABLE IF NOT EXISTS public.returns_ema_multi_tf_u_state (
    id               bigint NOT NULL,
    tf               text NOT NULL,
    period           integer NOT NULL,
    alignment_source text NOT NULL,
