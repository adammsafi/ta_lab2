...
-- Source bars: public.price_bars_multi_tf_cal_us
-- PK: (id, "timestamp", tf)
-- ============================

DROP TABLE IF EXISTS public.returns_bars_multi_tf_cal_us CASCADE;

CREATE TABLE public.returns_bars_multi_tf_cal_us (
    id                      integer       NOT NULL,
    ...
    CONSTRAINT returns_bars_multi_tf_cal_us_pk PRIMARY KEY (id, "timestamp", tf)
);

CREATE INDEX IF NOT EXISTS ix_returns_bars_multi_tf_cal_us_id_tf_ts
ON public.returns_bars_multi_tf_cal_us (id, tf, "timestamp");

DROP TABLE IF EXISTS public.returns_bars_multi_tf_cal_us_state CASCADE;

CREATE TABLE public.returns_bars_multi_tf_cal_us_state (
    id              integer       NOT NULL,
    tf              text          NOT NULL,
    last_timestamp  timestamptz,
    updated_at      timestamptz   NOT NULL DEFAULT now(),
    CONSTRAINT returns_bars_multi_tf_cal_us_state_pk PRIMARY KEY (id, tf)
);
