-- cmc_fear_greed_state: refresh watermark for Fear & Greed ingestion
-- Single-row table (singleton_key + CHECK constraint ensures exactly one row)

CREATE TABLE IF NOT EXISTS public.cmc_fear_greed_state (
...
COMMENT ON TABLE public.cmc_fear_greed_state IS
