-- cmc_fear_greed: Crypto Fear & Greed Index (daily)
-- Source: https://api.alternative.me/fng/
-- Refreshed by: ta_lab2.scripts.etl.refresh_fear_greed

CREATE TABLE IF NOT EXISTS public.cmc_fear_greed (
...
COMMENT ON TABLE public.cmc_fear_greed IS
'Crypto Fear & Greed Index from alternative.me. One row per UTC day, value 0-100.';

CREATE INDEX IF NOT EXISTS ix_cmc_fear_greed_value
    ON public.cmc_fear_greed (value);
