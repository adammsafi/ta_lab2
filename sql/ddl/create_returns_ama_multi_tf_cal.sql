-- create_returns_ama_multi_tf_cal.sql
-- Creates calendar-aligned AMA returns tables:
--   public.returns_ama_multi_tf_cal_us       (US calendar alignment)
--   public.returns_ama_multi_tf_cal_us_state
--   public.returns_ama_multi_tf_cal_iso      (ISO calendar alignment)
--   public.returns_ama_multi_tf_cal_iso_state
--
-- Same column schema as returns_ama_multi_tf.
-- PK: (id, ts, tf, indicator, params_hash)

BEGIN;

-- ============================================================
-- CAL US returns + state
-- ============================================================
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_cal_us (
    id              bigint       NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_cal_us_state (
    id          bigint      NOT NULL,
    tf          text        NOT NULL,
    indicator   text        NOT NULL,
    params_hash text        NOT NULL,
...
CREATE INDEX IF NOT EXISTS ix_cmc_returns_ama_cal_us_key
ON public.returns_ama_multi_tf_cal_us (id, tf, indicator, params_hash, ts);

CREATE INDEX IF NOT EXISTS ix_cmc_returns_ama_cal_us_ingested
ON public.returns_ama_multi_tf_cal_us (ingested_at);


-- ============================================================
-- CAL ISO returns + state
-- ============================================================
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_cal_iso (
    id              bigint       NOT NULL,
    ts              timestamptz  NOT NULL,
    tf              text         NOT NULL,
    tf_days         integer      NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.returns_ama_multi_tf_cal_iso_state (
    id          bigint      NOT NULL,
    tf          text        NOT NULL,
    indicator   text        NOT NULL,
    params_hash text        NOT NULL,
...
CREATE INDEX IF NOT EXISTS ix_cmc_returns_ama_cal_iso_key
ON public.returns_ama_multi_tf_cal_iso (id, tf, indicator, params_hash, ts);

CREATE INDEX IF NOT EXISTS ix_cmc_returns_ama_cal_iso_ingested
ON public.returns_ama_multi_tf_cal_iso (ingested_at);
