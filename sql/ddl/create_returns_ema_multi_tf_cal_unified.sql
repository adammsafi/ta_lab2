...
-- ============================================================
CREATE TABLE IF NOT EXISTS public.returns_ema_multi_tf_cal_us (
    id          bigint       NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.returns_ema_multi_tf_cal_us_state (
    id          bigint      NOT NULL,
    tf          text        NOT NULL,
    period      integer     NOT NULL,
    last_ts     timestamptz,
...
ON public.returns_ema_multi_tf_cal_us (ingested_at);


-- ============================================================
-- CAL ISO unified returns + state
-- ============================================================
CREATE TABLE IF NOT EXISTS public.returns_ema_multi_tf_cal_iso (
    id          bigint       NOT NULL,
    ts          timestamptz  NOT NULL,
    tf          text         NOT NULL,
    tf_days     integer      NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.returns_ema_multi_tf_cal_iso_state (
    id          bigint      NOT NULL,
    tf          text        NOT NULL,
    period      integer     NOT NULL,
    last_ts     timestamptz,
...
ON public.returns_ema_multi_tf_cal_iso (ingested_at);
