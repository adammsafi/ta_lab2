...
--   public.cmc_returns_ama_multi_tf_cal_us       (US calendar alignment)
--   public.cmc_returns_ama_multi_tf_cal_us_state
--   public.cmc_returns_ama_multi_tf_cal_iso      (ISO calendar alignment)
...
-- ============================================================
CREATE TABLE IF NOT EXISTS public.cmc_returns_ama_multi_tf_cal_us (
    id              bigint       NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.cmc_returns_ama_multi_tf_cal_us_state (
    id          bigint      NOT NULL,
    tf          text        NOT NULL,
    indicator   text        NOT NULL,
    params_hash text        NOT NULL,
...
ON public.cmc_returns_ama_multi_tf_cal_us (id, tf, indicator, params_hash, ts);

CREATE INDEX IF NOT EXISTS ix_cmc_returns_ama_cal_us_ingested
ON public.cmc_returns_ama_multi_tf_cal_us (ingested_at);


-- ============================================================
-- CAL ISO returns + state
-- ============================================================
CREATE TABLE IF NOT EXISTS public.cmc_returns_ama_multi_tf_cal_iso (
    id              bigint       NOT NULL,
    ts              timestamptz  NOT NULL,
    tf              text         NOT NULL,
    tf_days         integer      NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.cmc_returns_ama_multi_tf_cal_iso_state (
    id          bigint      NOT NULL,
    tf          text        NOT NULL,
    indicator   text        NOT NULL,
    params_hash text        NOT NULL,
...
ON public.cmc_returns_ama_multi_tf_cal_iso (id, tf, indicator, params_hash, ts);

CREATE INDEX IF NOT EXISTS ix_cmc_returns_ama_cal_iso_ingested
ON public.cmc_returns_ama_multi_tf_cal_iso (ingested_at);
