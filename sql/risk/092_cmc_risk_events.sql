-- cmc_risk_events: Immutable audit log for all risk control events.
...
CREATE TABLE public.cmc_risk_events (
    ...
    CONSTRAINT pk_cmc_risk_events PRIMARY KEY (event_id),
