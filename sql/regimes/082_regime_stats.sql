-- regime_stats: Pre-computed per-regime performance statistics
--
...
'Pre-computed regime performance statistics per asset/TF/regime. Refreshed alongside regimes. Used for regime-aware position sizing and dashboard analytics.';

COMMENT ON COLUMN public.regime_stats.pct_of_history IS
...
COMMENT ON COLUMN public.regime_stats.avg_ret_1d IS
'Mean 1-day forward return observed during bars where this regime was active.';

COMMENT ON COLUMN public.regime_stats.std_ret_1d IS
