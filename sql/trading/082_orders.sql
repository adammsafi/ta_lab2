-- orders: Master order record for the paper trading OMS.
...
CREATE INDEX idx_orders_asset_status
    ON public.orders (asset_id, status, created_at DESC);
