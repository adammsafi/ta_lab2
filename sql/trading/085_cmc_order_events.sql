-- cmc_order_events: Immutable audit trail of order state machine transitions.
...
CREATE TABLE public.cmc_order_events (
    ...
    CONSTRAINT pk_cmc_order_events PRIMARY KEY (event_id),
...
COMMENT ON TABLE public.cmc_order_events IS
