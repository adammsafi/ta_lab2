-- cmc_positions: Current position per (asset, exchange).
...
CREATE TABLE public.cmc_positions (
    ...
    CONSTRAINT pk_cmc_positions PRIMARY KEY (asset_id, exchange),

    -- exchange values: 'aggregate' reserved for v_cmc_positions_agg view
...
COMMENT ON TABLE public.cmc_positions IS
