# Requirements Archive: v0.9.0 Research & Experimentation
...
**Shipped:** 43 of 43 v0.9.0 requirements
**Adjusted:** None — all requirements shipped as originally defined
**Dropped:** None

**Deferred to v1.0.0:**
- ADV-01..04: Advanced analytics (quantile returns, KAMA crossover signal, PBO analysis, automated migration on promotion)
- INFR-01..03: Infrastructure (mypy strict, versioned docs, AMA calendar variants)

---
*Archived: 2026-02-24 as part of v0.9.0 milestone completion*
