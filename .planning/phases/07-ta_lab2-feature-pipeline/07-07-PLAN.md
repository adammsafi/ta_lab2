...
<task type="auto">
  ...
  <verify>
    python -c "from ta_lab2.scripts.features.validate_features import FeatureValidator, validate_features; v = FeatureValidator(None); print(hasattr(v, 'check_gaps') and hasattr(v, 'check_outliers') and hasattr(v, 'check_cross_table_consistency'))"
  </verify>
  <done>
    FeatureValidator imports with all validation methods (check_gaps, check_outliers, check_cross_table_consistency, etc.)
  </done>
</task>
