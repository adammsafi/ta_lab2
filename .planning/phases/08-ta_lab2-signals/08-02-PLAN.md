...
<task type="auto">
  ...
  <verify>
    Run: `python -c "from ta_lab2.signals.ema_trend import make_signals; print('OK')"`
    Verify ema_trend.make_signals exists and is importable.
...
- [ ] ema_trend.make_signals exists and is importable
