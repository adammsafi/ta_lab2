...
Purpose: Foundation for cross-system monitoring - all integration tests and production monitoring depend on this infrastructure. This is the "observability infrastructure" that Plan 09-03 tests.

Output: src/ta_lab2/observability/ module with tracing, metrics, health checks, and PostgreSQL storage.

Note: alerts.py is created separately in Plan 09-06 (depends on this infrastructure).
</objective>
