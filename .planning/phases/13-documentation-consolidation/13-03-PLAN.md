...
2. Create batch conversion script or run directly:
...
- Root: 2 docs -> docs/architecture/
  ...
  <done>
    ...
    - YAML front matter includes original metadata
    - Images extracted to docs/assets/
    - Files organized by category
    - Conversion log shows success/failure counts
  </done>
</task>
...
# YAML front matter present (check one file)
head -20 docs/architecture/core-components.md | grep -A5 "^---"

# No conversion errors (optional - log check)
# grep -c "ERROR" conversion.log || echo "No log or no errors"
```
</verification>
