...
Usage in Spyder (IPython console):
    ...
    %runfile C:/Users/asafi/Downloads/Data_Tools/run_refresh_ema_daily_stats.py \
...
Any --db-url argument is forwarded to ta_lab2.scripts.refresh_ema_daily_stats.main().
"""

from ta_lab2.scripts.emas.stats.daily.refresh_ema_daily_stats import main
