...
def main():
    ...
    query_embedding = client.embeddings.create(input=[args.query], model=args.embedding_model).data[0].embedding
    ...
    for i, doc in enumerate(results['documents'][0]):
        ...
        print(f"Source: {metadata.get('file_path')} (Line: {metadata.get('start_line')})")
