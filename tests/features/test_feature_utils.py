...
class TestAddZscore:
    ...
    def test_add_zscore_basic(self):
        ...
        df = pd.DataFrame({"price": [100, 102, 101, 103, 105, 104, 106, 108, 107, 109]})
    ...
    def test_add_zscore_custom_window(self):
        ...
        df = pd.DataFrame({"price": [100 + i for i in range(20)]})
...
class TestValidateMinDataPoints:
    ...
    def test_validate_min_data_points_valid(self):
        ...
        is_valid, count = validate_min_data_points(
            s, min_required=3, feature_name="test"
        )
    ...
    def test_validate_min_data_points_invalid(self):
        ...
        is_valid, count = validate_min_data_points(
            s, min_required=5, feature_name="test"
        )
    ...
    def test_validate_min_data_points_empty(self):
        ...
        is_valid, count = validate_min_data_points(
            s, min_required=1, feature_name="test"
        )
