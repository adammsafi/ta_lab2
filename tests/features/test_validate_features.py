...
class TestFeatureValidator(unittest.TestCase):
    ...
    def test_check_gaps_detects_missing(self):
        ...
        mock_result2.__iter__ = lambda self: iter(
            [(datetime(2024, 1, 1).date(),), (datetime(2024, 1, 3).date(),)]
        )
    ...
    def test_check_outliers_returns(self):
        ...
        mock_result3.__iter__ = lambda self: iter(
            [(1, datetime(2024, 1, 1), 0.75)]
        )  # 75% return
    ...
    def test_check_cross_table_returns(self):
        ...
        self.engine.connect.return_value.__enter__.return_value.execute.return_value = (
            mock_result
        )
        ...
        )  # May have 0-3 depending on mocks
    ...
    def test_validation_report_summary(self):
        ...
        issues = [
            GapIssue(
                table="test", id_=1, missing_dates=["2024-01-01"], expected=10, actual=9
            ),
