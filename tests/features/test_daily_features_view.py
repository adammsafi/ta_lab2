...
class TestDailyFeaturesStore(unittest.TestCase):
    ...
    def test_compute_dirty_window_no_state(self):
        ...
        with patch.object(self.store, 'get_source_watermarks') as mock_get:
            ...
            start, end = self.store.compute_dirty_window([1], default_start='2020-01-01')
    ...
    def test_refresh_for_ids_incremental(self):
        ...
        with patch.object(self.store, 'check_source_tables_exist') as mock_check, \
            ...
            mock_check.return_value = {'price_bars': True, 'emas': True, 'returns': True, 'vol': True, 'ta': True}
            mock_window.return_value = (pd.Timestamp('2024-01-01', tz='UTC'), pd.Timestamp('2024-12-31', tz='UTC'))
    ...
    def test_refresh_for_ids_full_refresh(self):
        ...
        with patch.object(self.store, 'check_source_tables_exist') as mock_check, \
            ...
            mock_check.return_value = {'price_bars': True, 'emas': False, 'returns': False, 'vol': False, 'ta': False}
            mock_window.return_value = (pd.Timestamp('2020-01-01', tz='UTC'), pd.Timestamp('2024-12-31', tz='UTC'))
            mock_query.return_value = "INSERT INTO ... SELECT ..."
    ...
    def test_asset_class_populated(self):
        ...
        sources_available = {'price_bars': True, 'emas': False, 'returns': False, 'vol': False, 'ta': False}
...
class TestRefreshFunction(unittest.TestCase):
    ...
    def test_refresh_daily_features_creates_components(self, mock_store_cls, mock_manager_cls):
    ...
    @patch('ta_lab2.scripts.features.feature_state_manager.FeatureStateManager')
    @patch('ta_lab2.scripts.features.daily_features_view.DailyFeaturesStore')
    def test_refresh_daily_features_passes_parameters(self, mock_store_cls, mock_manager_cls):
