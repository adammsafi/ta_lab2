...
Run (Spyder):
runfile(
  r"C:\Users\asafi\Downloads\ta_lab2\src\ta_lab2\scripts\returns\audit_returns_bars_multi_tf_cal_anchor_us_integrity.py",
  wdir=r"C:\Users\asafi\Downloads\ta_lab2",
  args="--out-dir audits/returns --out audit_returns_bars_multi_tf_cal_anchor_us"
)
"""
...
DEFAULT_RET_TABLE = "public.cmc_returns_bars_multi_tf_cal_anchor_us"


def _print(msg: str) -> None:
    print(f"[audit_ret_bars_cal_anchor_us] {msg}")
