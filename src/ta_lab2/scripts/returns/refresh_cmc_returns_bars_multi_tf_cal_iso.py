...
State:
  public.cmc_returns_bars_multi_tf_cal_iso_state  (watermark per (id, tf): last_time_close)
...
Run (Spyder):
runfile(
  r"C:\Users\asafi\Downloads\ta_lab2\src\ta_lab2\scripts\returns\refresh_cmc_returns_bars_multi_tf_cal_iso.py",
...
DEFAULT_OUT_TABLE = "public.cmc_returns_bars_multi_tf_cal_iso"
DEFAULT_STATE_TABLE = "public.cmc_returns_bars_multi_tf_cal_iso_state"


def _print(msg: str) -> None:
    print(f"[ret_bars_cal_iso] {msg}")
...
def ensure_tables(engine: Engine, out_table: str, state_table: str) -> None:
    ...
    idx_name = f"ix_{out_name}_time_close"
