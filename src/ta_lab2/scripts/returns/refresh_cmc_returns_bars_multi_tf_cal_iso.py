...
Source:  public.cmc_price_bars_multi_tf_cal_iso
Writes:  public.cmc_returns_bars_multi_tf_cal_iso
State:   public.cmc_returns_bars_multi_tf_cal_iso_state  (watermark per (id, tf): last_timestamp)
