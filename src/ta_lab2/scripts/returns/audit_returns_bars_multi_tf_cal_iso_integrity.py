...
runfile(
  ...
  args="--out-dir audits/returns --out audit_returns_bars_multi_tf_cal_iso"
)

Optional:
- Override tables:
  args="--bars-table public.cmc_price_bars_multi_tf_cal_iso --ret-table public.cmc_returns_bars_multi_tf_cal_iso --out-dir audits/returns --out audit_returns_bars_multi_tf_cal_iso"
"""
...
def _print(msg: str) -> None:
    print(f"[audit_ret_bars_cal_iso] {msg}")
