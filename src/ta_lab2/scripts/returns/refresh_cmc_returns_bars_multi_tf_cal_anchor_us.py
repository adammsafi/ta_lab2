...
Source:  public.cmc_price_bars_multi_tf_cal_anchor_us
Writes:  public.cmc_returns_bars_multi_tf_cal_anchor_us
State:   public.cmc_returns_bars_multi_tf_cal_anchor_us_state  (watermark per (id, tf): last_timestamp)
