...
Source:  public.price_bars_multi_tf_cal_us
Writes:  public.returns_bars_multi_tf_cal_us
State:   public.returns_bars_multi_tf_cal_us_state  (watermark per (id, tf): last_timestamp)
...
Run (Spyder):
runfile(
  r"C:\Users\asafi\Downloads\ta_lab2\src\ta_lab2\scripts\returns\refresh_returns_bars_multi_tf_cal_us.py",
...
DEFAULT_OUT_TABLE = "public.returns_bars_multi_tf_cal_us"
DEFAULT_STATE_TABLE = "public.returns_bars_multi_tf_cal_us_state"
