...
Source:  public.cmc_price_bars_multi_tf
Writes:  public.cmc_returns_bars_multi_tf
State:   public.cmc_returns_bars_multi_tf_state  (watermark per (id, tf): last_timestamp)
