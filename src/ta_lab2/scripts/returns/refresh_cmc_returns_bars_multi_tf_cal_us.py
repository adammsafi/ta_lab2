...
Source:  public.cmc_price_bars_multi_tf_cal_us
Writes:  public.cmc_returns_bars_multi_tf_cal_us
State:   public.cmc_returns_bars_multi_tf_cal_us_state  (watermark per (id, tf): last_timestamp)
