...
runfile(
  r"C:\Users\asafi\Downloads\ta_lab2\src\ta_lab2\scripts\returns\refresh_cmc_returns_bars_multi_tf_cal_anchor_iso.py",
  wdir=r"C:\Users\asafi\Downloads\ta_lab2",
  args="--bars-table public.cmc_price_bars_multi_tf_cal_anchor_iso "
       "--out-table public.cmc_returns_bars_multi_tf_cal_anchor_iso "
       "--state-table public.cmc_returns_bars_multi_tf_cal_anchor_iso_state"
)
"""
...
def _print(msg: str) -> None:
    print(f"[ret_bars_cal_anchor_iso] {msg}")
