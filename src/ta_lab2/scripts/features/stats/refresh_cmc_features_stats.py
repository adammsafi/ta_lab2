...
r"""
refresh_cmc_features_stats.py

Stats runner for public.cmc_features.

Incremental behavior:
- Uses public.cmc_features_stats_state as watermark store
...
CLI:
  python -m ta_lab2.scripts.features.stats.refresh_cmc_features_stats
  python -m ta_lab2.scripts.features.stats.refresh_cmc_features_stats --full-refresh

Spyder:
runfile(
  r"C:\Users\asafi\Downloads\ta_lab2\src\ta_lab2\scripts\features\stats\refresh_cmc_features_stats.py",
...
FEATURE_TABLE = "public.cmc_features"
STATS_TABLE = "public.cmc_features_stats"
STATE_TABLE = "public.cmc_features_stats_state"
...
def _setup_logging(level: str = "INFO") -> logging.Logger:
    logger = logging.getLogger("cmc_features_stats")
    if logger.handlers:
        return logger
...
def main() -> None:
    p = argparse.ArgumentParser(description="Stats runner for cmc_features")
