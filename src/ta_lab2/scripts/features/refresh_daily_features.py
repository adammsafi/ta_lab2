...
Usage:
    python -m ta_lab2.scripts.features.refresh_daily_features --ids 1,52
    python -m ta_lab2.scripts.features.refresh_daily_features --all
    python -m ta_lab2.scripts.features.refresh_daily_features --full-refresh
...
State tracked in public.feature_state (feature_type='daily_features').
"""
