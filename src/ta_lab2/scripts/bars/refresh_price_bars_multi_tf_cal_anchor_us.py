...
class AnchorCalendarUSBarBuilder(BaseBarBuilder):
    ...
    STATE_TABLE = "public.price_bars_multi_tf_cal_anchor_us_state"
    OUTPUT_TABLE = "public.price_bars_multi_tf_cal_anchor_us"
    ...
    def create_argument_parser(cls) -> argparse.ArgumentParser:
        ...
        parser = cls.create_base_argument_parser(
            description="Build US calendar-anchored price bars into price_bars_multi_tf_cal_anchor_us.",
...
def main(argv=None) -> None:
    ...
    Usage:
        python refresh_price_bars_multi_tf_cal_anchor_us.py --ids all
        python refresh_price_bars_multi_tf_cal_anchor_us.py --ids 1 52 825 --full-rebuild
        python refresh_price_bars_multi_tf_cal_anchor_us.py --ids all --from-1d
    """
