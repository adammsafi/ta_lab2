...
DEFAULT_BARS_TABLE = "public.price_bars_multi_tf_cal_iso"
DEFAULT_STATE_TABLE = "public.price_bars_multi_tf_cal_iso_state"
...
class CalendarISOBarBuilder(BaseBarBuilder):
    ...
    STATE_TABLE = "public.price_bars_multi_tf_cal_iso_state"
    OUTPUT_TABLE = "public.price_bars_multi_tf_cal_iso"
    ...
    def create_argument_parser(cls) -> argparse.ArgumentParser:
        ...
        parser = cls.create_base_argument_parser(
            description="Build calendar-aligned ISO price bars (Monday-start weeks) into price_bars_multi_tf_cal_iso.",
...
def main(argv=None) -> None:
    ...
    Usage:
        python refresh_price_bars_multi_tf_cal_iso.py --ids all
        python refresh_price_bars_multi_tf_cal_iso.py --ids 1 52 825 --full-rebuild
        python refresh_price_bars_multi_tf_cal_iso.py --ids all --from-1d
    """
