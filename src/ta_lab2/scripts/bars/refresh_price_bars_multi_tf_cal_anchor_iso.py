...
class AnchorCalendarISOBarBuilder(BaseBarBuilder):
    ...
    def _build_bars_for_id_tf(
        ...
        if not needs_full and state is not None:
            ...
            # Build bars on incremental data — bar_seq will start from 1
            ...
            # Fix bar_seq: offset by last known bar_seq minus 1 (since the
            # first bar in incremental is the continuation of the last bar)
