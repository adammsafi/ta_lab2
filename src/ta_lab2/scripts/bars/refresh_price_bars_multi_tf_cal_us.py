...
class CalendarUSBarBuilder(BaseBarBuilder):
    ...
    def create_argument_parser(cls) -> argparse.ArgumentParser:
        ...
        parser = cls.create_base_argument_parser(
            description="Build calendar-aligned US price bars (Sunday-start weeks) into price_bars_multi_tf_cal_us.",
...
def main(argv=None) -> None:
    ...
    Usage:
        python refresh_price_bars_multi_tf_cal_us.py --ids all
        python refresh_price_bars_multi_tf_cal_us.py --ids 1 52 825 --full-rebuild
        python refresh_price_bars_multi_tf_cal_us.py --ids all --from-1d
    """
