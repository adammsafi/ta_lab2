"""
Refresh ama_multi_tf - Main multi-TF AMA refresh script.
...
Output table: public.ama_multi_tf
...
class MultiTFAMARefresher(BaseAMARefresher):
    """
    AMA refresher for ama_multi_tf (multi-timeframe canonical bars).
    ...
    def get_description(self) -> str:
        return (
            "Refresh ama_multi_tf with KAMA, DEMA, TEMA, HMA across all "
            "109 timeframes from price_bars_multi_tf."
        )
