...
Targets:
  - public.ama_multi_tf_cal_anchor_us   (US calendar-anchor bars)
  - public.ama_multi_tf_cal_anchor_iso  (ISO calendar-anchor bars)
...
CLI usage:
  ...
  python -m ta_lab2.scripts.amas.refresh_ama_multi_tf_cal_anchor_from_bars \\
...
class CalAnchorAMARefresher(BaseAMARefresher):
    ...
    def get_description(self) -> str:
        return (
            ...
            "Data sources:\n"
            "  price_bars_multi_tf_cal_anchor_us  -> ama_multi_tf_cal_anchor_us\n"
            "  price_bars_multi_tf_cal_anchor_iso -> ama_multi_tf_cal_anchor_iso\n\n"
    ...
    def create_argument_parser(cls) -> argparse.ArgumentParser:
        ...
        p.add_argument(
            "--out-us",
            default="ama_multi_tf_cal_anchor_us",
            help=(
        ...
        p.add_argument(
            "--out-iso",
            default="ama_multi_tf_cal_anchor_iso",
            help=(
