...
Targets:
  - public.cmc_ama_multi_tf_cal_us   (US calendar-aligned bars)
  - public.cmc_ama_multi_tf_cal_iso  (ISO calendar-aligned bars)
...
CLI usage:
  ...
  python -m ta_lab2.scripts.amas.refresh_cmc_ama_multi_tf_cal_from_bars \\
...
SCHEME_MAP = {
    "us": {
        ...
        "bars_table": "cmc_price_bars_multi_tf_cal_us",
        "output_table": "cmc_ama_multi_tf_cal_us",
        "state_table": "cmc_ama_multi_tf_cal_us_state",
        "description": "US calendar-aligned AMA",
    },
    "iso": {
        "feature_class": CalISOAMAFeature,
        "bars_table": "cmc_price_bars_multi_tf_cal_iso",
        "output_table": "cmc_ama_multi_tf_cal_iso",
        "state_table": "cmc_ama_multi_tf_cal_iso_state",
...
class CalAMARefresher(BaseAMARefresher):
    ...
    def get_description(self) -> str:
        return (
            ...
            "Data sources:\n"
            "  cmc_price_bars_multi_tf_cal_us  -> cmc_ama_multi_tf_cal_us\n"
            "  cmc_price_bars_multi_tf_cal_iso -> cmc_ama_multi_tf_cal_iso\n\n"
    ...
    def create_argument_parser(cls) -> argparse.ArgumentParser:
        ...
        p.add_argument(
            "--out-us",
            default="cmc_ama_multi_tf_cal_us",
            help="Output table name for US scheme (default: cmc_ama_multi_tf_cal_us).",
        )
        p.add_argument(
            "--out-iso",
            default="cmc_ama_multi_tf_cal_iso",
            help="Output table name for ISO scheme (default: cmc_ama_multi_tf_cal_iso).",
        )
